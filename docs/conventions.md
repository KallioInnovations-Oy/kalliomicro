...
- **Known gaps to plan for before production:** login throttling, multi-replica session storage, scheduler overlap locking, SSO pre-provisioning (see the ⚠ markers in [auth.md](auth.md) and [console.md](console.md)).
