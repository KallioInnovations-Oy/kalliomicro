...
Official specification of the KallioMicro framework — a minimal, secure PHP 8.1+ MVC framework by KallioInnovations Oy, designed as a reusable base for downstream projects.
